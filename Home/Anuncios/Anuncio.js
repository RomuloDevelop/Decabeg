...
//   progressBarHandle(){
//     try {
//       if(!(this.state.containerMounted && this.props.modalVisible && this.state.isReady)) {
//         return;
//       }
//       if(this._youTubeRef) {
//         this._youTubeRef
//           .currentTime()
//           .then(currentTime => currentTime)
...
//         }}
//       >
//         {this.state.containerMounted && this.props.modalVisible && ( 
...
//             videoIds={[ 'ncw4ISEU5ik', 'w5LYm_zSeFU', 'ygGb3N_Nko4' ]}
